  ...
  .controller('PipelineHomeController', function (
    ...
    $scope.$on('showMappingView', function (event, options) {
      ...
      setTimeout(function(){ 
        ...
        if(current_mapping) {
          ...
          ifrm.mydesigner.init(schema, {mode: 'cluster-clone'}) 
        ...
        ifrm.mydesigner.on('savedocument', r => {
          ...
          $rootScope.$broadcast('pip-saveUpdates', $scope.pipelineConfig)
          // $rootScope.$broadcast('onNodeSelection', self.mongoNodeOption)
        })
      }, 1000)
    });
    ...
    $scope.$on('onNodeSelection', function (event, options) {
      ...
      setTimeout(function(){
        ...
        if(options.selectedObject.stageName === "com_streamsets_pipeline_stage_destination_http_HttpClientDTarget"){
          ...
          if(!existed) {
            ...
            tab-heading-transclude="" class="ng-binding">
                ...
                <span class="ng-binding" style="color: #337ab7;">Edit Mapping</span>
              </tab-heading>
            </div>  
            </li> `))
          }
