...
angular
  ...
  .controller('PipelineHomeController', function (
    ...
    $scope.$on('showMappingView', function (event, options) {
      ...
      //   if (e.data === 'loaded') {
      //     this.mappingEditorCondition = true
      //     // TODO
      //     this.ifrm.mydesigner.on('fullscreen', r => {
      //       this.iframeStyle = {
      //         'z-index': 1000,
      //         overflow: 'hidden',
      //         height: '100%',
      ...
      //       }
      //       setTimeout(() => {
      //         vm.ifrm.mydesigner.resize()
      //       }, 1000)
      //     })
      //     this.ifrm.mydesigner.on('normalscreen', r => {
      //       this.iframeStyle = {
      //         overflow: 'hidden',
      //         height: document.getElementsByTagName('main')[0].clientHeight - 270 + 'px',
      //         width: '100%'
      //       }
      //       setTimeout(() => {
      //         vm.ifrm.mydesigner.resize()
      //       }, 1000)
      //     })
      //     this.ifrm.mydesigner.on('preview', r => {
      //       if (r) {
      //         this.mappings = JSON.parse(r.data)
      //         this.preview()
      //       }
      //     })
      //   }
